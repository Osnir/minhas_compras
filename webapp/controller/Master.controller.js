/*global history */
sap.ui.define([
		"ovly/mm/minhas_compras/controller/BaseController",
		...
		"sap/ui/Device",
		"ovly/mm/minhas_compras/model/formatter",
		"ovly/mm/minhas_compras/model/grouper",
		"ovly/mm/minhas_compras/model/GroupSortState"
		...
		return BaseController.extend("ovly.mm.minhas_compras.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("ovly.mm.minhas_compras.view.ViewSettingsDialog", this);
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var sObjectId = mParams.firstListitem.getBindingContext().getProperty("PoKey");
			...
			_showDetail : function (oItem) {
				...
				this.getRouter().navTo("object", {
					objectId : oItem.getBindingContext().getProperty("PoKey")
				}, bReplace);
			},
