sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ovly/mm/minhas_compras/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#MinhasCompras-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#MinhasCompras-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("ovly.mm.minhas_compras.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ovly/mm/minhas_compras/localService/mockserver"], function (mockserver) {
