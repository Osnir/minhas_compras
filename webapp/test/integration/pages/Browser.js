				...
				iChangeTheHashToObjectN : function (iObjIndex) {
					return this.waitFor(this.createAWaitForAnEntitySet({
						...
						success : function (aEntitySet) {
							Opa5.getHashChanger().setHash("/Headers/" + aEntitySet[iObjIndex].PoKey);
						}
					}));
				},
				...
				iChangeTheHashToTheRememberedItem : function () {
					return this.waitFor({
						success : function () {
							...
							Opa5.getHashChanger().setHash("/Headers/" + sObjectId);
						}
					});
				},
				...
				iShouldSeeTheHashForObjectN : function (iObjIndex) {
					return this.waitFor(this.createAWaitForAnEntitySet({
						...
						success : function (aEntitySet) {
							...
							Opa5.assert.strictEqual(sHash, "Headers/" + aEntitySet[iObjIndex].PoKey, "The Hash is not correct");
						}
					}));
				},
					...
					return this.waitFor({
						success : function () {
							var sObjectId = this.getContext().currentItem.id,
								...
								sHash = oHashChanger.getHash();
							Opa5.assert.strictEqual(sHash, "Headers/" + sObjectId, "The Hash is not correct");
						}
					});
				},
